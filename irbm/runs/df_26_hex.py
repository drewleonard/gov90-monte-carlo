...
#
# SUBMUNITION N: 825 BOMBLETS
# SUBMUNITION PAYLOAD: 1 LB EACH
#
...
df_26_hit_locations_permanent = []

# FOR EACH NUMBER OF LEAKERS POSSIBLE ...

for df_26_leaker_n in range(df_26_sent, df_26_sent + 1):
    ...
    for monte_carlo_iteration in range(0, monte_carlo_iterations):
        ...
        while df_26_n < df_26_leaker_n:
            ...
            df_26_hit_locations_permanent.append(df_26_hit_location)
        ...
        for df_26_target in df_26_targets:
            ...
            for df_26_hit_location in df_26_hit_locations:
                ...
                if (df_26_distance_from_df_26_target < df_26_dist_radius_m):
...
pickle.dump(df_26_hit_locations_permanent, open("df_26_hex.p", "wb"))
