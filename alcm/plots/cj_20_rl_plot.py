...
cj_20_rl_200 = pickle.load(open( "cj_20_rl_2import os
import csv
import numpy as np
from random import *
from math import *
...
cj_20_dist_radius_m = 200  # m (distributed circularly)
...
pickle.dump(cj_20_leaker_iterations, open("cj_20_rl_200.p", "wb"))00.p", "rb" ))
