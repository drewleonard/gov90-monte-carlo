...
monte_carlo_iterations = 10000  # temporarily low value to spare my computer

sigma = cj_20_cep_m / 0.675  # getting normal distribution from CEP
mu = 0

cj_20_leaker_iterations = {}
cj_20_hit_locations_permanent = []

# FOR EACH NUMBER OF LEAKERS POSSIBLE ...

for cj_20_leaker_n in range(cj_20_sent, cj_20_sent + 1):
    ...
    for monte_carlo_iteration in range(0, monte_carlo_iterations):
        ...
        while cj_20_n < cj_20_leaker_n:
            ...
            cj_20_hit_locations_permanent.append(cj_20_hit_location)
...
pickle.dump(cj_20_hit_locations_permanent, open("cj_20_hex.p", "wb"))